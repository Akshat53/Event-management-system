        ...
        <div class="modal-body">
          ...
          <div class="form-group">
           ...
           <div class="form-group">
            ...
            <input type="text" class="form-control form2" name="student_id" placeholder="Enter Student ID" style="background-color: white;" required>
          </div>
           <div class="form-group">
...
<!-- Modal -->
 ...
 <hr>
      <div class="user">
        <img src="images/club/res.png" alt="user" />
    ...
    <section class="ftco-section">
      <div class="container">
        <div class="row">
          ...
          <?php 
      include("dbs/connect.php");
      $sql="SELECT  id, role, post, name, image FROM admin where id = '8'";
      $results=$connect->query($sql);
      ...
      ?>
          <div class="col-md-12">
            <div class="featured-carousel owl-carousel">
              <div class="item">
                <div class="work">
                  <div class="img d-flex align-items-end justify-content-center" style="background-image: url(ABHIRUCHI1/<?php echo $final[4] ?>);">
