  ...
  <center>
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-sm-4"> <img src="images/images.png"  style="width:100%;"></div>
        <div class="col-sm-1" style=""></div>
        <div class="col-sm-4" style="">
        <br>
          <p>This club is a portrayal of our University and its aspirations provides an excellent opportunity to unveil the hidden talent and showcase its accomplishments to the world with the help of Invertis University. This club conducts various events to motivate students in terms of writings and Public speaking...</p>
          <br>
          <br>
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
           ...
           <label for="">Email ID</label >
            <input type="email" class="form-control form2" name="email" placeholder="Enter Enmail ID" style="background-color: white;" required>
          </div>
          <div class="form-group">
...
<!-- Modal -->
 ...
 <hr>
      <div class="user">
        <img src="images/club/images.png" alt="user" />
    ...
    <section class="ftco-section">
      <div class="container">
        <div class="row">
          ...
          <?php 
      include("dbs/connect.php");
      $sql="SELECT  id, role, post, name, image FROM admin where id = '6'";
      $results=$connect->query($sql);
