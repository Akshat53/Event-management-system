  ...
  <center>
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-sm-4"> <img src="images/rockon1.png"  style="width:100%;"></div>
        <div class="col-sm-1" style=""></div>
        <div class="col-sm-4" style="">
        <br>
          <p>This club encourages enjoying all aspects of the performing arts (singing, dancing, and acting) as they learn the skills to showcase their talents. The mission of this Club is to give students an opportunity to familiarize themselves with art, culture and music.</p>
          <br>
          <br>
...
<!-- Modal -->
 ...
 <hr>
      <div class="user">
        <img src="images/club/rock.png" alt="user" />
    ...
    <section class="ftco-section">
      <div class="container">
        <div class="row">
          ...
          <?php 
      include("dbs/connect.php");
      $sql="SELECT  id, role, post, name, image FROM admin where id = '5'";
      $results=$connect->query($sql);
