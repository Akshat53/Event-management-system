...
<body>
  <div class="container-flui-0 pr-0 bg-img clearfix parallax-window2" data-parallax="scroll" data-image-src="images/banner.jpg">
    <?php
    ...
    <div class="container">
      <div class="fh5co-banner-text-box">
        ...
        <a href="#pan" class="btn text-uppercase btn-outline-danger btn-lg mr-3 mb-3 wow bounceInUp">Go For More</a>
       
      </div>
    </div>
  </div>

<div class="container-fluid fh5co-network" id="pan">
  <div class="container">
    <div class="row">
      <div class="col-md-6">
...
<div class="container-fluid fh5co-network t">
  <div class="container">
    <div class="row">
      <div class="col-md-6">
        <h4 class="wow bounceInUp" style="color: white;">The publication Club</h4>
        <h2 class="wow bounceInRight">IMAGES</h2>
        <hr>
        <h5 class="wow bounceInLeft" style="color: white;">ABHIRUCHI</h5>
        <p class="wow bounceInDown" style="color: white;">This club is a portrayal of our University and its aspirations provides an excellent opportunity to unveil the hidden talent and showcase its accomplishments to the world with the help of Invertis University. This club conducts various events to motivate students in terms of writings and Public speaking..</p>
      </div>
      <div class="col-md-6">
        <figure class="wow bounceInDown">
          <img src="images/p.png" alt="gym" class="img-fluid">
        </figure>
        <center>
        <br>
          <a href="images.php" class="btn text-uppercase btn-outline-danger btn-lg mb-3 wow bounceInDown"> Read More</a>
        </center> 
      </div>
    </div>
  </div>
...
<div class="container-fluid fh5co-network t">
  <div class="container">
    <div class="row">
      <div class="col-md-6">
        <h4 class="wow bounceInUp" style="color: white;">The Management Club</h4>
        <h2 class="wow bounceInRight">M-Factor</h2>
        <hr>
        <h5 class="wow bounceInLeft" style="color: white;">ABHIRUCHI</h5>
        <p class="wow bounceInDown" style="color: white;">This Club incepts the basics of all Managerial skills that are needed to be perfect in whatever field you choose. The club organizes, plan, implement, design management games which are the major parts of events at our University. M- Factor provides direction and guidance so each individual – as well as the department as a whole – can accomplish their tasks and achieve their goals..</p>
      </div>
      <div class="col-md-6">
        <figure class="wow bounceInDown">
          <img src="images/m.png" alt="gym" class="img-fluid">
        </figure>
        <center>
        <br>
          <a href="mfactor.php" class="btn text-uppercase btn-outline-danger btn-lg mb-3 wow bounceInDown"> Read More</a>
        </center> 
      </div>
    </div>
  </div>
...
<div class="container-fluid fh5co-network t">
  <div class="container">
    <div class="row">
      <div class="col-md-6">
        <h4 class="wow bounceInUp" style="color: white;">Social Club</h4>
        <h2 class="wow bounceInRight">The Responsible Invertian</h2>
        <hr>
        <h5 class="wow bounceInLeft" style="color: white;">ABHIRUCHI</h5>
        <p class="wow bounceInDown" style="color: white;">This club is a modern combination of several types of activities and reflects today's more eclectic and varied segments of our society. The objectives of this club are centered on the activities related to the poor & needy sections of our society and work to improve their socioeconomic status. The Responsible Invertian has a strong passion to change society today and build a better India for tomorrow..</p>
      </div>
      <div class="col-md-6">
        <figure class="wow bounceInDown"> 
          <img src="images/res2.png" alt="gym" class="img-fluid">
        </figure>
        <center>
        <br>
          <a href="responsible.php" class="btn text-uppercase btn-outline-danger btn-lg mb-3 wow bounceInDown"> Read More</a>
        </center> 
      </div>
    </div>
  </div>
...
<div id="about-us" class="container-fluid fh5co-about-us pl-0 pr-0 parallax-window" >
  <div class="container">
    <div class="col-sm-6 offset-sm-6">
      ...
      <hr>
      <p class="wow bounceInRight" data-wow-delay=".25s" style="color:black;">In Invertis University The Way Team Plays As A whole Determines It Success. You May Have The Greatest Bunch Of Individuals Stars In The World But If They Don't Play Together, The Club Won't Be Worth A dime</p>
      <a class="btn btn-lg btn-danger d-inline-block text-center mx-auto wow bounceInDown" href="https://www.invertisuniversity.ac.in/">Learn More</a> 
    </div>
  </div>
</div>
