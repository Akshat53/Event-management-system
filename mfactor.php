  ...
  <center>
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-sm-4"> <img src="images/mfactor.png"  style="width:100%;"></div>
        <div class="col-sm-1" style=""></div>
...
<div class="modal fade" id="form" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    ...
    <h5 class="modal-title" id="exampleModalLabel">Apply For M-factore Club </h5>
...
<!-- Modal -->
 ...
 <hr>
      <div class="user">
        <img src="images/club/mfactor.png" alt="user" />
    ...
    <section class="ftco-section">
      <div class="container">
        <div class="row">
          ...
          <?php 
      include("dbs/connect.php");
      $sql="SELECT  id, role, post, name, image FROM admin where id = '7'";
      $results=$connect->query($sql);
